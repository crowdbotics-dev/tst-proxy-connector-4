"""
Django settings for tst_proxy_connector_4 project.
...
ROOT_URLCONF = 'tst_proxy_connector_4.urls'
...
WSGI_APPLICATION = 'tst_proxy_connector_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_proxy_connector_4 API",
    "DESCRIPTION": "API documentation for tst_proxy_connector_4 App",
    "VERSION": "v1",
}
