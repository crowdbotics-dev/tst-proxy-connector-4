...
## Project Structure
    ...
    ├── tst_proxy_connector_4  # Django project configurations
...
1. Clone this repo and `cd tst_proxy_connector_4`
...
2. Clone this repo and `cd tst_proxy_connector_4`
